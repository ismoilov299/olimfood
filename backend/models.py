...
class Product(Base):
    ...
    characteristics_uz  = Column(Text, default="")
    characteristics_uzl = Column(Text, default="")
    characteristics_ru  = Column(Text, default="")
    ...
    min_qty     = Column(Float, nullable=True)   # minimum orderable quantity; falls back to step when unset
